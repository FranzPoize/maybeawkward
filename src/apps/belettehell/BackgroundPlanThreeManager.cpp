...
const float BackgroundPlanThreeManager::cameraFactor(PLAN_THREE_FACTOR);

BackgroundPlanThreeManager::BackgroundPlanThreeManager()
{
	for (int i = 3;i<4;i++)
	{
...
void BackgroundPlanThreeManager::addTerrain()
{
